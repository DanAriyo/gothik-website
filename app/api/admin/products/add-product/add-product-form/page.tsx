...
export default function AddProductForm({ categories }: { categories: any[] }) {
  ...
  return (
    <form
      ...
      className="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-zinc-950 p-8 rounded-xl border border-zinc-900 shadow-[0_0_50px_rgba(0,0,0,0.8)] max-w-5xl mx-auto"
    >
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-zinc-900">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              {/* Contatore dello sconto dinamico e illuminato */}
            ...
            <div className="relative flex items-center h-[46px] bg-black px-4 border border-zinc-800 rounded">
              <input
                ...
                min="0"
                max="75"
                step="5" // Si muove a scatti di 5% per evitare percentuali strane (es. 23%)
                value={discount}
            ...
            {/* Il valore viene comunque passato tranquillamente alla tua Server Action qui */}
        ...
        {rawPrice && (
          <div className="p-4 bg-black/40 rounded-lg border border-zinc-900 flex justify-between items-center transition-all animate-fade-in">
      ...
      <div className="lg:col-span-5 flex flex-col justify-between space-y-6 lg:border-l lg:border-zinc-900 lg:pl-8">
              ...
              >
                ...
                <span className="text-[9px] text-zinc-600 font-mono mt-2 uppercase tracking-tighter">
                  {images.length === 0
                    ...
                    : `${images.length} file pronti nell'abissio`}
                </span>
              </button>
            )}
          </CldUploadWidget>
        ...
        {/* BOTTONE PUBBLICA (Ancorato perfettamente in fondo a destra) */}
        <div className="pt-4 border-t border-zinc-900 lg:border-t-0 lg:pt-0">
          <button
            type="submit"
            disabled={images.length === 0}
            className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-zinc-900/50 disabled:text-zinc-700 disabled:border-zinc-900 disabled:cursor-not-allowed text-white font-black py-4 rounded-lg shadow-[0_0_20px_rgba(168,85,247,0.2)] hover:shadow-[0_0_35px_rgba(168,85,247,0.4)] transition-all duration-300 uppercase text-xs tracking-[0.25em] border border-purple-500/30 disabled:shadow-none"
          >
            Pubblica
          </button>
        </div>
